...
namespace Acounting_basic.Controllers
{
    public class FornecedorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Endereço,Telefone,Email")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Endereço,Telefone,Email")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
