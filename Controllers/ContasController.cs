...
namespace Acounting_basic.Controllers
{
    public class ContasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Tipo,Saldo_Atual")] Conta conta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Tipo,Saldo_Atual")] Conta conta)
        {
            if (id != conta.Id)
            {
                return NotFound();
