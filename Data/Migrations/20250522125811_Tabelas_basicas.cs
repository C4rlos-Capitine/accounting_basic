...
{
    /// <inheritdoc />
    public partial class Tabelas_basicas : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefone_empresa = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Celular_empresa = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Endereco_empresa = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NUIT_empresa = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_minhaEmpresas", x => x.Id);
                });
